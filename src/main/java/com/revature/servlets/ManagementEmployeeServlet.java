        ...
        try {
            ...
            if (session != null && !session.isNew()) {
                ...
                if (user.getType().equals("Manager")) {
                    ...
                    out.println("<script>\n\tdocument.getElementById('all-employees-link').classList.toggle('active')\n</script>");
    ...
    private String employeeRequest(int id){
        ...
        for (Reimbursement reimbursement : reimbursements) {
                output.append("<div>").append("<div class='card w-75 mx-auto mb-3'>" +
                        ...
                        "<p class='card-text'>" + (reimbursement.getImage().isEmpty() ? "":("<img src='" + reimbursement.getImage() + "' class=\"card-img-bottom\" style=\"object-fit:contain\" height=" + 600 + " width=" + 200 + ">")) +
